    ...
    return {
      ...
      compile: function (tElement, tAttrs, transclude) {
        ...
        $(window).on('resize', function (e) {
          if ($('body').width() < 600) width = 4
          else if ($('body').width() < 1200) width = 5
          else width = 6
    ...
    function ($compile) {
      return {
        ...
        link: function (scope, element, attrs) {
          ...
          if ($('body').width() < 600) width = 200 - margin.left - margin.right
          ...
          scope.init = function (width) {
            ...
            var bar = svg
              ...
              .on('mouseover', function (d) {
                tip.show(d, d3.select(this).select('.bar').node())
              })
            ...
            bar
              ...
              .attr('fill', function (d) {
                return d3.rgb(color(d.x)).brighter(0.7).toString()
              })
              .attr('rx', 1)
              .attr('ry', 1)
              .attr('width', x(data[0].dx + data[0].x) - x(data[0].x) - 1)
